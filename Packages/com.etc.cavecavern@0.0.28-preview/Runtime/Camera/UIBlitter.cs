...
namespace ETC.CaveCavern
{
    ...
    public class UIBlitter : MonoBehaviour
    {
        ...
        public RenderCam quadCam;
        public void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            //ApplyUIToRT(quadCam.RI, uiCamera.RT);
        }
        public void ApplyUIToRT(RenderTexture source, RenderTexture destination)
        {
            ...
            Graphics.Blit(temp, null as RenderTexture);
