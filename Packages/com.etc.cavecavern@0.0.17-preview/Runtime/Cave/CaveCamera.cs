...
namespace ETC.CaveCavern
{
    ...
    public class CaveCamera : MonoBehaviour
    {
        ...
        public void AssembleCameras()
        {
            ...
            GameObject multiCamParent = new GameObject("MultiCamParent");
            multiCamParent.transform.SetParent(transform.parent, false);
            ...
            for (int eye = -1; eye <= 1; eye+=2)
            {
                ...
                for (int i = 0; i < CavernLegacyController.panelCount(); i++)
                {
                    ...
                    // Parent under sub child object for project cleanliness / handling rotation
                    cam.transform.parent = multiCamParent.transform;
